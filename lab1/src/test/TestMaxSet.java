...
public class TestMaxSet {
	...
	public final void testUniqueElements() {
		int[] unsorted = new int[]{7,5,3,5,2,2,7};
		int[] sorted = new int[]{2,3,5,7};
		int[] result = UniqueElements.uniqueElements(unsorted);
		
		assertTrue("Sort failed.",Arrays.equals(sorted,result));
